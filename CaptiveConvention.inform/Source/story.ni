...
Announcment booth is south of Main Hall. "This is where people make announcments during events. There are nice comfy chairs here, and microphone on top of a desk. The microphone used for making announcements. There is also a container underneath the desk."

Wood drawer is a closed openable container in the Announcment Booth. The description is "This is a wood drawer used for storing things for the announcers. Nothing specal about it"
...
[[if Battery1 and Battery2 is in radio] The radio is now operational. Who should I call for help?[end if]]

Comfy chair is an enterable supporter in Announcment booth. It is undescribed. The description is "This is the chair that announcers use when waiting for something to announce."

Instead of entering comfy chair, say "I shouldn't sit down now, I gotta get out of here!"

Office is east of Announcent Booth. "This looks like the office of the owner of the Convention center. [if call is 1] Mr. Morton said that the key is hidden in his desk.[end if]"

Secret drawer is an openable container. It is nowhere

[If Call count is equal to 1:
	Move Secret drawer to Office
	Move Secret key into drawer]
...
Winning Area is north of Front door. "I'm free!"

Rule for printing room description details: stop

An every turn rule:
	If player is in Winning Area:
